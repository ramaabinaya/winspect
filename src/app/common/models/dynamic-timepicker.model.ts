import { DynamicFormValueControlModelConfig,
  ...
  * @type {string}
  */
 export const DYNAMIC_FORM_CONTROL_TYPE_CUSTOMTIMEPICKER = 'CUSTOMTIMEPICKER';
 /**
  * Class which is used to define the model configuration properties.
  */
 export interface DynamicCustomTimepickerModelConfig extends DynamicFormValueControlModelConfig<string | number | Date | string[]> {
   /**
...
//    subcategoryName?: string;
  ...
  */
 export class DynamicCustomTimepickerModel extends DynamicFormValueControlModel<string | number | Date | string[]> {
   /**
    * Variable which is used to define type of the model.
    * @type {string}
    */
   @serializable() readonly type: string = DYNAMIC_FORM_CONTROL_TYPE_CUSTOMTIMEPICKER;
   /**
    ...
    */
   constructor(config: DynamicCustomTimepickerModelConfig, layout?: DynamicFormControlLayout) {
     super(config, layout);
   }
}
